...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  var markup;
  if (type === 'success') {
    markup = "<div class=\"alert--container\">\n        <div class=\"alert alert--".concat(type, "\"><i class=\"fa fa-check\"></i>\n            <div class=\"alert--body\">").concat(msg, "</div>\n        </div>\n    </div>");
  } else if (type === 'error') {
    markup = "<div class=\"alert--container\">\n        <div class=\"alert alert--".concat(type, "\"><i class=\"fa fa-times\"></i>\n            <div class=\"alert--body\">").concat(msg, "</div>\n        </div>\n    </div>");
  }
  ;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Registration is successful!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          endPoint = type === 'data' ? 'updateMe' : 'updateMyPassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
...
var logOutBttn = document.querySelector('#logout--btn');
var signUpForm = document.querySelector('.form--signup');
var updateMeForm = document.querySelector('.settings--form');
if (loginForm) {
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.querySelector('#passConfirm').value;
...
if (updateMeForm) {
  updateMeForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(dataObj, 'data');
  });
}
},{"./alerts":"alerts.js","./login":"login.js","./signup":"signup.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
